...
import type { Voucher, Pagination as PaginationType } from "@/types";
...
export default function AdminVouchers() {
  ...
  const fetchVouchers = (p = page, status = isActiveFilter, q = search) => {
    setLoading(true);
    operationAPI
      .voucherStats({ 
        page: p, 
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setPage(1);
      fetchVouchers(1, isActiveFilter, search);
    }, 500);
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-foreground/50 text-sm mt-1">
                Quản lý và theo dõi tỷ lệ sử dụng Voucher
              </p>
            </div>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {vouchers.map((v) => {
            ...
            return (
              <div
                key={v._id}
                className={`glass-card relative overflow-hidden transition-all duration-300 ${!isAvailable ? "opacity-70 grayscale" : "hover:scale-[1.02]"}`}
              >
                <div
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-xl font-bold font-mono text-foreground tracking-widest">
                      {v.code}
                    </h3>
                  </div>
                  ...
                  <div className="space-y-1 mb-6">
                    ...
                    <div className="w-full h-2 bg-foreground/10 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, (v.currentUsage / v.maxUsage) * 100)}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="p-2 bg-foreground/5 hover:bg-foreground/10 text-foreground/60 hover:text-foreground rounded-lg transition-colors"
                    >
        ...
        {vouchers.length === 0 && !loading && (
          <div className="glass-card py-20 flex flex-col items-center text-center">
            ...
            <p className="text-foreground/50">
              Tạo voucher mới để thu hút khách hàng đặt vé.
            </p>
          </div>
        )}
